...
Cut_CoinFinds$total.gold = NA
Cut_CoinFinds$total.silver = NA
Cut_CoinFinds$total.bronze = NA
Cut_CoinFinds$total.lead = NA
...
for (z in c(1:cf_nrow)) {
  ...
  Cut_CoinFinds$total.gold[index] = point_gold
  Cut_CoinFinds$total.silver[index] = point_silver
  Cut_CoinFinds$total.bronze[index] = point_bronze
  Cut_CoinFinds$total.lead[index] = point_lead
...
```{r}
FULL_clusters = data.frame(cfID = TEST_CoinFinds$ID, name = TEST_CoinFinds$cf_name, author = TEST_CoinFinds$cf_user, clusterID = TEST_CoinFinds$clusterID, 
